        ...
        {allSkills.map((skill) => {
          ...
          return (
            <Badge
              key={skill.name}
              variant="secondary"
              className="flex items-center gap-2 px-3.5 py-2 rounded-full bg-white/[0.06] hover:bg-white/[0.1] border border-white/10 text-white/80 text-[0.9rem] transition-colors"
            >
